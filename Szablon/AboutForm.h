...
namespace Szablon {
	...
	private:
		void AboutForm_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e);
	protected:
		/// <summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(141, 559);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(500, 29);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Naciœnij klawisz \'M\', aby zamkn¹æ to okno.";
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(166, 526);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(448, 24);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Zastosowanie Programowania Obiektowego";
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(250, 492);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(261, 24);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Politechnika Koszaliñska";
			// 
			// groupBox1
			// 
			this->groupBox1->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(0)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(192)));
			...
			this->groupBox1->Size = System::Drawing::Size(234, 93);
			this->groupBox1->TabIndex = 3;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"Autor";
			// 
			// label6
			// 
			...
			this->label6->Location = System::Drawing::Point(16, 60);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(197, 19);
			this->label6->TabIndex = 5;
			this->label6->Text = L"Semestr V, Grupa II, 2025";
			// 
			// label5
			// 
			...
			this->label5->Location = System::Drawing::Point(16, 41);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(218, 19);
			this->label5->TabIndex = 4;
			this->label5->Text = L"Informatyka Niestacjonarny";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Maksymilian Mas³owski";
			// 
			// AboutForm
			// 
			...
			this->ClientSize = System::Drawing::Size(750, 596);
			...
			this->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &AboutForm::AboutForm_KeyPress);
